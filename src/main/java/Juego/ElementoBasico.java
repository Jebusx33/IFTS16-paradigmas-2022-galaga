...
public abstract class ElementoBasico implements Elemento {
	...
	public boolean hayColision(Elemento elemento) {
		if (Utilidades.hayColision(this.getPosicionX(), this.getPosicionY(), this.getAncho(), this.getLargo(),
				elemento.getPosicionX(), elemento.getPosicionY(), elemento.getAncho(), elemento.getLargo())) {
			return true;
		} else {
			return false;
		}
